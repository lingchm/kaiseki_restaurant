...
$form = array(
	'subject' => 'Envío de Formulario Contacto Sant Feliu',
	'heading' => 'Envío de nuevo formulario',
	'success_redirect' => 'gracias-por-contactar.html',
	'resources' => array(
	...
	'email' => array(
		'from' => 'santfeliu@kaiseki.es',
		'to' => 'santfeliu@kaiseki.es'
	),
	'fields' => array(
		'custom_U3099' => array(
			'order' => 1,
			'type' => 'string',
			'label' => 'Kaiseki Sant Feliu


Nombre',
			'required' => true,
			'errors' => array(
				'required' => 'El campo \'Kaiseki Sant Feliu
